...
import { getCafeAdvertisements } from '../../actions/advertisementAction';
...
const Slideshowcafe = () => {
  ...
  const { advertisements, loading, error } = useSelector((state) => state.cafeAdvertisementReducer);

  useEffect(() => {
    dispatch(getCafeAdvertisements(selectedCity));
