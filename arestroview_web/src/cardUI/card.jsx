...
// const Card = ({ name, title, frontImage, rating, image, description, restaurantId,category }) => {
//   const frontStyle = {
...
//     try {
//       dispatch(followRestaurantOrCafe(userId, restaurantOrCafeOrVendorId,category));
...
const Card = ({ name, title, frontImage, rating, image, description, restaurantId, category }) => {
  ...
  const isFollowing = followingList.some(item => item._id === restaurantId);
